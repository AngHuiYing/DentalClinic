...
$record_stmt = $conn->prepare("
    ...
    WHERE mr.id = ? AND mr.patient_email = ?
");
...
// 标记报告已生成
$update_stmt = $conn->prepare("UPDATE medical_records SET report_generated = TRUE WHERE id = ?");
...
<head>
    <meta charset="UTF-8">
    <title>Dental Medical Report - Admin View</title>
    <style>
        body {
        ...
        @media print {
            .print-btn, .back-btn, .admin-controls, .admin-badge { display: none; }
...
<body>
    <div class="report-container">
        ...
        <div class="admin-controls">
            ...
            <p style="margin: 0; color: #666;">
                <strong>Access Level:</strong> Full administrative access to all patient medical records<br>
                <strong>Generated By:</strong> Admin - <?= htmlspecialchars($_SESSION['admin_username'] ?? 'System Admin') ?><br>
                <strong>Record Status:</strong> 
                <span style="color: #28a745; font-weight: 600;">
                    ✅ Report Generated & Accessible
                </span>
            </p>
        </div>
        ...
        <div class="report-meta">
            ...
            <strong>Medical Record ID:</strong> #<?= str_pad($record_data['id'], 6, '0', STR_PAD_LEFT) ?><br>
        ...
        <div class="signature-section">
            ...
            <p style="font-size: 0.9rem; color: #ff6b6b; font-weight: 600;">
                <em>Administrator Access: This report was accessed with full administrative privileges.</em>
            </p>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Admin Medical Report View Loaded');
